...
- (void)openLinkFromRow:(NSUInteger)row {
    ...
    switch (row) {
        case ZBDiscord:{
            ...
            break;
        case ZBWilsonTwitter: {
            NSURL *twitterapp = [NSURL URLWithString:@"twitter:///user?screen_name=acresons"];
            NSURL *tweetbot = [NSURL URLWithString:@"tweetbot:///user_profile/acresons"];
            NSURL *twitterweb = [NSURL URLWithString:@"https://twitter.com/acresons"];
